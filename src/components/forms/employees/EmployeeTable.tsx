  ...
  const columns: GridColDef<Employee>[] = [
    ...
    },
    {
      ...
      // valueGetter: (value, row) =>
        // formatNumber(row.aboutEmployee?.rentalPriceCurrent),
    },
    {
      field: "purchaseDate",
      headerName: "วันที่ซื้อ",
      width: 150,
      // valueGetter: (value, row) => row.aboutEmployee?.purchaseDate,
    },
    {
      field: "unitName",
      headerName: "หน่วยเรียก",
      width: 150,
      // valueGetter: (value, row) => row.aboutEmployee?.unitName,
    },
    {
      field: "stockStatus",
      headerName: "สถานะ",
        ...
        <Box sx={{ display: "grid", gap: 3 }} mb={4} mt={4}>
          <Grid2 container spacing={2}>
            ...
            <Grid2 size={3}>
              ...
              >
                {/* {Object.values(EmployeeStatus).map((option) => (
